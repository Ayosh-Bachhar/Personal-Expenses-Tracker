...
function SpreadsheetSetupPage() {
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      setMessage('Spreadsheet verified and setup saved successfully. You can now use the app pages.');
    } catch (error) {
    ...
    <p>Required permanent sheets:</p>
        ...
        <ul className="list-inside list-disc">
            ...
            The app writes balance, expense, and debt records into the current monthly sheet.
              ...
              <p>
                If any sheet or header is missing, setup will fail. This protects
                the app from writing data into the wrong structure.
              </p>
            </div>
          </div>
          ...
          <div className="rounded-3xl border border-slate-800 bg-slate-900/80 p-6">
            ...
            <p className="mt-3 text-sm leading-6 text-slate-400">
              Open your Google Sheet. Copy the part of the URL between /d/ and
              /edit.
            </p>
